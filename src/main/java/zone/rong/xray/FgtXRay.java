...
public class FgtXRay {
    ...
    public static final int[] distNumbers = new int[] // Radius +/- around the player to search. So 8 is 8 on left and
                                                      // right of player plus under the player. So 17x17 area.
    { 8, 16, 32, 48, 64, 80, 128, 256 };
    // Keybindings
    ...
    public static boolean skipGenericBlocks = true; // See ClientTick.run() thread. Skip common blocks in
     ...
     * put( "oreType", new OreInfo(...) ) oreType is the ore dictionary string id. Press Print OreDict and check console
     * to see list.
